          ...
          <Route path="/" element={
            <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '60vh' }}>
              <div className="card shadow p-4" style={{ maxWidth: 500 }}>
                <h1 className="display-4 mb-3 text-primary text-center">Welcome to OctoFit Tracker!</h1>
                ...
                <div className="d-flex justify-content-center mt-3">
                  ...
                  <Link to="/leaderboard" className="btn btn-outline-success mx-2">Leaderboard</Link>
                </div>
              </div>
            </div>
          } />
